...
export const BUILTIN_CHAT_MODELS: ChatModelDefinition[] = [
  ...
  // ---- Google Gemini 模型 ----
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Gemini 3 Flash 预览版，轻量快速，适合文本生成',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Gemini 3 Pro 预览版，适合复杂文本生成任务',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Gemini 2.5 Flash Lite，成本更低的文本生成',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Gemini 2.5 Flash，快速稳定的文本生成',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  ...
  },
  {
    ...
    type: 'chat',
    providerId: 'deepseek',
    description: 'DeepSeek Reasoner，偏重推理与文本生成',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  // ---- Volcengine (Doubao) 模型 ----
  {
  ...
  },
  {
    ...
    apiModel: 'doubao-seed-1-6-flash-250828',
...
export const BUILTIN_IMAGE_MODELS: ImageModelDefinition[] = [
  {
    ...
    type: 'image',
    providerId: 'google',
    description: 'Gemini 3 Pro 图片生成模型（Preview）',
    isBuiltIn: true,
    isEnabled: true,
  ...
  },
  {
    ...
    type: 'image',
    providerId: 'google',
    description: 'Gemini 2.5 Flash Image 图片生成模型',
    isBuiltIn: true,
    isEnabled: true,
    params: { ...DEFAULT_IMAGE_PARAMS },
  },
