...
export const BUILTIN_CHAT_MODELS: ChatModelDefinition[] = [
  ...
  // ---- Google Gemini 模型 ----
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Google Gemini 2.0 Flash 实验版，快速响应，适合对话和文本生成',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Google Gemini 1.5 Pro，强大的多模态模型，适合复杂任务',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  {
    ...
    type: 'chat',
    providerId: 'google',
    description: 'Google Gemini 1.5 Flash，快速且高效，适合日常对话',
    isBuiltIn: true,
    isEnabled: false,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
