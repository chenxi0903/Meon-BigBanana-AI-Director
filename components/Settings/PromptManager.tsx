...
const PROMPT_CATEGORIES = [ 
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'buildSeedanceAdvancedModePrompt', title: 'Seedance 2.0 高级模式 (Beta)', type: 'Prompt', isDefault: true, usage: '【高级模式】跳过分镜，直接生成15秒间隔的物料提示词。', content: 'You are a professional film director and cinematographer...' },
  ...
  { 
    ...
    items: [ 
      ...
      { id: 'buildQVersionThreeViewPrompt', title: 'Q版三视图生成', type: 'Prompt', isDefault: true, usage: '生成Q版角色的三视图样式。', content: '请将我发送给你的参考图生成为Q版角色的三视图样式，保留角色的主要特征（如发型、衣服、配饰、肤色等）。角色的外形要更加夸张可爱，头部相对较大，眼睛大而亮，身体比例缩小，整体显得更加卡通化和萌趣。请提供角色的正面、侧面和背面三视图，确保每个角度都能准确展示角色的标志性特征和个性细节' },
      { id: 'buildQVersionEmotionGridPrompt', title: 'Q版情绪九宫格生成', type: 'Prompt', isDefault: true, usage: '生成Q版角色的情绪九宫格。', content: '以参考图中的 Q 版三视图角色为基础，生成一套 9 个的 Q 版表情包，排成 3x3 网格。每个表情都是同一个角色，保持原有的发型、服饰和画风，只改变面部表情和情绪符号，包括：\n1. 害羞脸红冒汗\n2. 愤怒冒火\n3. 疑惑问号\n4. 花痴爱心眼\n5. 黑化暴走\n6. 大哭流泪\n7. 流汗无语\n8. 惊讶张嘴\n9. 怒吼咆哮整体\n风格为可爱的卡通插画，每个表情都有夸张的动作和符号化元素，背景为纯白色。' },
    ] 
  }, 
  { 
